...
public class SnowFlakeUtils {
    ...
    public SnowFlakeUtils(String machineId) {
...
//    private static String myid= SysConstant.LOCAL_MACHINE_ID;
    ...
    // 示例
    private static SnowFlakeUtils instance = new SnowFlakeUtils(myid);
    ...
    public static  String getOrderNumber() {
        ...
        SnowFlakeUtils orderId = SnowFlakeUtils.getInstance();
    ...
    public static  String getTradeNo() {
        ...
        SnowFlakeUtils trade = SnowFlakeUtils.getInstance();
        String nextId = trade.nextId();
