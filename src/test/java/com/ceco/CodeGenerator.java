...
/**
 * create by fuzhuan on 2020/8/18 17:30
 *
...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        dsc.setUsername("zflive");
        dsc.setPassword("zfadmin!");
...
//        strategy.setSuperControllerClass("你自己的父类控制器,没有就不用设置!");
        // 写于父类中的公共字段
        strategy.setSuperEntityColumns("id","create_by","create_time","create_name","update_by","update_time","update_name");
        strategy.setInclude(scanner("表名，多个英文逗号分割").split(","));
        strategy.setControllerMappingHyphenStyle(true);
        strategy.setTablePrefix("ce_");
